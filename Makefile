...
wordcount:
	...
	docker run --network ${DOCKER_NETWORK} --env-file ${ENV_FILE} --restart on-failure:5 ivcinform/hadoop-base:1.2.1-hadoop2.8-java8 hdfs dfs -copyFromLocal /opt/hadoop-2.8.0/README.txt /input/
